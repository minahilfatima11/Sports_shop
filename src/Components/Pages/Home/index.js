                    ...
                    <div className="row">
                        ...
                        <div className="col-md-9 productRow">
                                    ...
                                    <SwiperSlide>
                                        <div className="item productitem">
                                            <div className="imgWrapper">
                                                <img src="https://apollosports.pk/wp-content/uploads/2024/03/Metador-Cricket-Tapeball-Bat-Fiber-XF-1000-Green2-600x600.jpg" className='w-100' alt="product1" />
                                            ...
                                            <div className="info">
                                                ...
                                                <div className="d-flex">
                                                    <span className="netprice text-danger">Rs-2100</span>
                                                </div>
                                            </div>
                                        </div>
                                    </SwiperSlide>
                            ...
                            <div className="product_row poductRow2 w-100 mt-4 d-flex">
                                        ...
                                        <div className="item productitem">
                                            <div className="imgWrapper">
                                                <img src="https://apollosports.pk/wp-content/uploads/2024/04/Apollo-Football-Keeping-Gloves-Black-2411-543-200917-600x600.jpg" className='w-100' alt="product1" />
                                                  <div className="actions">
                                                    <Button className="button"><AiOutlineFullscreen/></Button>
                                                    <Button className="button"><IoHeartOutline/></Button>
                                                </div>
                                            ...
                                            <div className="info">
                                                <h4>Goal Keeping Gloves</h4>
                                                <span className="text-success d-block ml-2">In Stock</span>
                                                <Rating className="mt-2 mb-2 ml-1" name="read-only" value={5} readOnly size="small" precision={0.5} />
                                                <div className="d-flex">
                                                    <span className="netprice text-danger">Rs-820</span>
                                                </div>
                                            </div>
                                        </div>
                                       ...
                                       <div className="item productitem">
                                        ...
                                        <div className="item productitem">
                                            <div className="imgWrapper">
                                                <img src="https://apollosports.pk/wp-content/uploads/2024/07/PROKENNEX-Badminton-Racket-Power-Pro-707-YellowBlack-600x600.jpg" className='w-100' alt="product1" />
                                                  <div className="actions">
                                                    <Button className="button"><AiOutlineFullscreen/></Button>
                                                    <Button className="button"><IoHeartOutline/></Button>
                                                </div>
                                            ...
                                            <div className="info">
                                                ...
                                                <Rating className="mt-2 mb-2 ml-1" name="read-only" value={5} readOnly size="small" precision={0.5} />
                                                <div className="d-flex">
                                                    <span className="netprice text-danger">Rs-2980</span>
                                                </div>
                                            </div>
                                </div>
